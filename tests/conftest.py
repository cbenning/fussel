...
def sample_config_dict():
    ...
    return {
        "gallery": {
            ...
            "people": {"enable": True},
            "watermark": {"enable": True, "path": "web/src/images/fussel-watermark.png", "size_ratio": 0.3},
            "albums": {"recursive": True, "recursive_name_pattern": "{parent_album} > {album}"},
            "overwrite": False,
            "exif_transpose": False,
            "parallel_tasks": 2,
        },
        "site": {"title": "Test Gallery", "http_root": "/"},
    }
