...
class TestMain:
    ...
    def test_main_success(self, mock_yaml_config_class, mock_os, mock_shutil,
                          mock_massedit, mock_site_generator_class):
        """Test successful main execution."""
        # Setup mocks
        mock_config = Mock()
        mock_config.getKey = Mock(side_effect=lambda key, default=None: {
            'site.http_root': '/',
    ...
    @patch('fussel.fussel.os')
    @patch('fussel.fussel.YamlConfig')
    def test_main_yarn_not_found(self, mock_yaml_config_class, mock_os, mock_shutil,
                                  mock_massedit, mock_site_generator_class):
    ...
    @patch('fussel.fussel.os')
    @patch('fussel.fussel.YamlConfig')
    def test_main_yarn_build_fails(self, mock_yaml_config_class, mock_os, mock_shutil,
                                    mock_massedit, mock_site_generator_class):
